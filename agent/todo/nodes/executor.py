...
[생성 및 시간 조율 규칙]
1. **정확히 5개의 추천 일정을 생성**하십시오.
2. 제안하는 5개 일정은 **서로 시간이 겹치지 않도록 조율**하여 제안하십시오.
   - 예: 오전 10:00, 오전 11:00, 오후 14:00, 오후 15:00, 오후 16:00와 같이 각기 다른 시간 슬롯(1시간 단위)을 부여하십시오.
   - PB의 기존 캘린더 일정과 겹치지 않는 빈 시간대를 우선 매칭하십시오.
...
"""
    ...
    try:
        ...
        # Heuristic Fallback 데이터 작성 (기념일/만기 골고루 5개 적재)
        execution_results = [
            {
